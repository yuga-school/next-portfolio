...
const Page: React.FC = () => {
  ...
  const [currentCategorydetail, setCurrentdetailCategory] = useState<
    string | undefined
  >(undefined);
  ...
  useEffect(() => {
    ...
    if (currentCategory !== undefined) {
      ...
      setCurrentdetailCategory(currentCategory.detail);
    }
  }, [categories, id]);
  ...
  const updateNewCategorydetail = (e: React.ChangeEvent<HTMLInputElement>) => {
    console.log(newCategorydetail)
    setNewCategoryNameError(isValidCategoryName(e.target.value));
    setNewCategorydetail(e.target.value);
  };
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const res = await fetch(requestUrl, {
        ...
        body: JSON.stringify({ name: newCategoryName,detail: newCategorydetail }),
      });
    ...
    <main>
      ...
      >
        <div className="space-y-6">
          ...
          <div className="space-y-1">
            <div className="block font-bold">現在のカテゴリの詳細</div>
            <div className="text-gray-500">{currentCategorydetail}</div>
          </div>
          <div className="space-y-2">
            ...
            <input
              ...
              required
            />
            <label htmlFor="detail" className="block font-bold">
              新しいカテゴリの詳細
            </label>
            <input
              type="text"
              ...
              name="detail"
              className="w-full rounded-md border-2 px-2 py-1"
              placeholder="新しいカテゴリの詳細を記入してください"
              value={newCategorydetail}
              onChange={updateNewCategorydetail}
              autoComplete="off"
              required
            />
